...
<body>
    ...
    <script>
        ...
        // Función para formatear precios con dos decimales, coma como separador decimal, y punto como separador de miles
        ...
        document.getElementById('search-input').addEventListener('input', function() {
            searchCompras(); // Llamar a la función de búsqueda cuando se escribe
        });
