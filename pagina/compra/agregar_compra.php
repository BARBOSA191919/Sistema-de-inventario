...
// Query SQL para obtener los nombres de los proveedores
$queryProveedores = "SELECT IdProveedor, Nombre FROM Proveedor WHERE Estado = 1";

// Ejecutar la consulta de proveedores
$resultProveedores = mysqli_query($conn, $queryProveedores);

// Inicializar un array para almacenar los nombres de los proveedores
$proveedores = [];

// Obtener los nombres de los proveedores del resultado de la consulta
if (mysqli_num_rows($resultProveedores) > 0) {
    while ($row = mysqli_fetch_assoc($resultProveedores)) {
        $proveedores[$row['IdProveedor']] = $row['Nombre'];
    }
}
...
<head>
    ...
    <link rel="stylesheet" href="../../css/compra/agregar_compra_styles.css">
</head>
...
<body>
    ...
    <div class="content">
        ...
        <div class="body-content">
            <div class="container">
                <div class="add-entry">
                    <img src="../../img/svg/add.svg" alt="Agregar Compra">
                    <span class="title">Nueva Compra</span>
                </div>
                <form action="../../php/compra/create_compra.php" method="POST" class="form-columns" onsubmit="return validarFormulario()">
                    <div class="input-entrada">
                        <div class="input-group">
                            <label for="proveedor">Proveedor</label>
                            <select id="proveedor" name="proveedor" required>
                                <?php
                                // Iterar sobre los nombres de los proveedores para generar las opciones del select
    ...
    <script>
        ...
        function validarFormulario() {
            ...
            if (filasProductos.length === 0) {
                alert("Debes seleccionar al menos un producto antes de agregar la compra.");
        ...
        function addProductToTable(productInfo) {
            ...
            <td><input type="number" name="cantidad[]" value="1" min="1" class="quantity-input"></td>
