...
<head>
    ...
    <link rel="stylesheet" href="../../css/contacto/cliente_styles.css"> <!-- Cambiar el nombre del archivo CSS -->
</head>
...
<body>
    ...
    <div class="content">
        ...
        <div class="body-content">
            <div id="search-container">
                <input type="text" id="search-input" placeholder="Buscar clientes..."> <!-- Cambiar el placeholder -->
                <button id="search-button">Buscar</button>
            </div>
            <div id="action-buttons">
                <button id="delete-button">Eliminar cliente</button> <!-- Cambiar el texto del botón -->
                <button id="add-button">Agregar cliente</button> <!-- Cambiar el texto del botón -->
            </div>
    ...
    <script src="../../javascrip/contacto/cliente_scripts.js"></script>
</body>
