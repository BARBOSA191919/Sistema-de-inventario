...
<head>
    ...
    <link rel="stylesheet" href="../../css/contacto/agregar_proveedor_styles.css">
</head>
...
<body>
    ...
    <div class="content">
        ...
        <div class="body-content">
            <div class="container">
                <div class="add-user">
                    <img src="../../img/svg/add_user.svg" alt="Agregar Proveedor">
                    <span class="title">Agregar Proveedor</span>
                </div>
                <form action="../../php/contacto/create_proveedor.php" method="POST" class="form-columns">
