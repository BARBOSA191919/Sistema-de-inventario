...
<head>
    ...
    <link rel="stylesheet" href="../../css/contacto/actualizar_cliente_styles.css">
</head>
...
<body>
    ...
    <div class="content">
        ...
        <div class="title-section">
            <img src="../../img/svg/contact.svg" alt="Cliente" class="title-svg">
            <span>Cliente</span>
        </div>
        <div class="body-content">
            <div class="container">
                <div class="add-user">
                    <img src="../../img/svg/edit.svg" alt="Editar Cliente"> 
                ...
                ?>
                        <form action="../../php/contacto/update_cliente.php" method="POST" id="edit-client-form" class="form-columns">
                ...
                <?php
                        ...
                        echo "<p>No se encontraron datos de cliente para editar.</p>";
                    }
